...
import static smc.minjoon.accompanying.R.layout.confirm_reservation_user_item;
...
public class ReservationUserListAdapter extends BaseAdapter {
    ...
    String helperID2;
    String status2;
    public ReservationUserListAdapter(Context context, List<Reservation> ReservationList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View v=View.inflate(context, confirm_reservation_user_item, null);
        ...
        TextView status =(TextView)v.findViewById(R.id.statustv2);

        Button statusBtn = (Button)v.findViewById(R.id.statusBtn2);
...
//        TextView ReservationHelperID=(TextView)v.findViewById(R.id.h_id);
        ...
        if(status2.equals("신청완료")){
            status.setTextColor(Color.parseColor("#D4F4FA"));
        }
        ...
        statusBtn.setTag(ReservationList.get(i));
            ...
            statusBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(context,userListClickedActivity.class);
