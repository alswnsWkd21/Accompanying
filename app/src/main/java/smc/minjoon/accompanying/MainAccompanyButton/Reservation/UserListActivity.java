    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            while(count<jsonArray.length()){
                ...
                Reservation reservation=new Reservation(userID,reservationID,reservationPlace,reservationDate,reservationTime,reservationWork);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                Intent intent=new Intent(UserListActivity.this,userListClickedActivity.class);
