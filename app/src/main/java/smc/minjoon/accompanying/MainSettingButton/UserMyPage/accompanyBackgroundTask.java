...
public class accompanyBackgroundTask extends AsyncTask<Void,Void,String>
{
    String target;
    String param2;
    Context activity;
    ...
    public accompanyBackgroundTask(Context activity, String id, String param){
    ...
    public void onPostExecute(String result){
        if(param.equals("ReservationList.php?userID=")){
