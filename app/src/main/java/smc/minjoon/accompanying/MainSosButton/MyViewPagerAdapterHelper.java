...
public class MyViewPagerAdapterHelper extends FragmentStatePagerAdapter{
    ...
    public MyViewPagerAdapterHelper(FragmentManager fm) {

        super(fm);

        fragments[0] = new FragmentD();

        fragments[1] = new FragmentE();

        fragments[2] = new FragmentF();
